...
step 'iOS bundle'
npx expo export --platform ios --output-dir "${TMPDIR:-/tmp}/dicewit-verify-ios" >/dev/null

step 'Android bundle'
npx expo export --platform android --output-dir "${TMPDIR:-/tmp}/dicewit-verify-android" >/dev/null
