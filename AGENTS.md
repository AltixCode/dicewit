...
`/Volumes/ExtremePro/Dev/mobile_expo_apps/_shared/ADS-PLAN.md`.
...
Fix it there, then re-render — `node scripts/bootstrap.mjs dicewit` or
...
| | |
|---|---|
| Bundle id / package | `com.altixcode.dicewit` |
| Scheme | `dicewit://` |
| RevenueCat entitlement | `remove_ads` |
| RevenueCat package | `$rc_lifetime` |
| iOS product | `com.altixcode.dicewit.removeads` |
| Android product | `remove_ads` |
| GitHub | `AltixCode/dicewit` |
