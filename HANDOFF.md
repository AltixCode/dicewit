...
| | State | Id |
|---|---|---|
| Bundle id registered | ✅ | `com.altixcode.dicewit` |
| App Store Connect record | ✅ | `6812380496` — store name "Dicewit" |
...
| AdMob app — iOS | ✅ | `ca-app-pub-2504845459806550~7035391566` |
| AdMob app — Android | ✅ | `ca-app-pub-2504845459806550~5073152217` |
| AdMob ad units (6) | ✅ | iOS banner/interstitial/rewarded `5569257495` / `6391384572` / `9750763824`; Android `7582186474` / `4990672998` / `6269104800` |
...
| RevenueCat project, apps, entitlement, offering | ✅ | project `projd33fe5c9`, entitlement `entld6237001db`, offering `ofrng270f01c131` |
